/**
 * Form Content Image Handler (Internal API)
 *
 * Handles upload of arbitrary content images for use in form content blocks
 * and success messages. Unlike SEO images, these are not stored in a database
 * field - the URL is embedded directly in the content JSON.
 */
...
export async function uploadContentImage(
  ...
  const key = `forms/${formId}/content/image-${timestamp}.${extension}`;
