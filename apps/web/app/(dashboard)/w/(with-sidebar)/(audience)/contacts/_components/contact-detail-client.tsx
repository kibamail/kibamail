...
export function ContactDetailClient({ contact }: ContactDetailClientProps) {
  return (
    <div className="space-y-6">
      {/* Contact Information */}
      <div className="mt-4">
        <Text className="mb-4">Contact Information</Text>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-kb-surface-secondary rounded-lg">
          <div>
            <Text className="text-kb-content-tertiary">Email</Text>
            <Text className="font-medium">{contact.email}</Text>
          </div>
          <div>
            <Text className="text-kb-content-tertiary">Status</Text>
            <div className="mt-1">
              <Badge
                variant={
          ...
          {contact.firstName && (
            <div>
              <Text className="text-kb-content-tertiary">First Name</Text>
              <Text className="font-medium">{contact.firstName}</Text>
            </div>
          )}
          {contact.lastName && (
            <div>
              <Text className="text-kb-content-tertiary">Last Name</Text>
              <Text className="font-medium">{contact.lastName}</Text>
            </div>
          )}
          {contact.phone && (
            <div>
              <Text className="text-kb-content-tertiary">Phone</Text>
              <Text className="font-medium">{contact.phone}</Text>
            </div>
          )}
          {contact.country && (
            <div>
              <Text className="text-kb-content-tertiary">Country</Text>
              <Text className="font-medium">{contact.country}</Text>
            </div>
          )}
          {contact.city && (
            <div>
              <Text className="text-kb-content-tertiary">City</Text>
              <Text className="font-medium">{contact.city}</Text>
            </div>
          )}
          {contact.timezone && (
            <div>
              <Text className="text-kb-content-tertiary">Timezone</Text>
              <Text className="font-medium">{contact.timezone}</Text>
            </div>
          )}
          <div>
            <Text className="text-kb-content-tertiary">Created</Text>
          ...
          <div>
            <Text className="text-kb-content-tertiary">Last Updated</Text>
            <Text className="font-medium">
