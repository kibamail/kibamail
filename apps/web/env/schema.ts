...
export const env = createEnv({
  ...
  server: {
    ...
    // NATS CONFIGURATION
    // ============================================================================
    // NATS is used for communication between the control plane and email agents.
    // The control plane publishes email jobs to NATS, and email agents consume them.
    // @see https://nats.io/
     ...
     * Use tls:// prefix for TLS connections.
     *
     * Common values:
     * - Development (Docker): tls://localhost:4222
     * - Production: tls://nats.cluster.kbmta.net:4222
     *
     * @example "tls://localhost:4222"
     */
    NATS_URL: z
      .string()
     ...
     * - Never commit to version control
     *
     * @example "control_plane_dev_password"
     */
    NATS_PASSWORD: z
      .string()
      .optional()
     ...
     *
     * The CA certificate for verifying the NATS server's TLS certificate.
     * Base64 encode the certificate file: base64 -i ca.pem
     *
     * For development, this is auto-generated by docker/nats/generate-certs.sh
     * For production, use the CA certificate from the MTA cluster.
     *
